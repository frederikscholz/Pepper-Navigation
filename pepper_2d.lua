...
TRAJECTORY_BUILDER_2D.voxel_filter_size = 0.085
...
--TRAJECTORY_BUILDER_2D.real_time_correlative_scan_matcher.translation_delta_cost_weight = 2e-1
--TRAJECTORY_BUILDER_2D.real_time_correlative_scan_matcher.rotation_delta_cost_weight = 1e-1
TRAJECTORY_BUILDER_2D.motion_filter.max_time_seconds = 0.4
...
POSE_GRAPH.constraint_builder.min_score = 0.83
